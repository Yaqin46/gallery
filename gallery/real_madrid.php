...
// Ambil data foto dengan kategori "Real Madrid"
$query = "SELECT * FROM foto WHERE kategori='Real Madrid' ORDER BY TanggalUnggah DESC";
...
<div class="container">
    ...
    <h2 class="text-center my-4">Album Real Madrid</h2>
    <div class="row">
