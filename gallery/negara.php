...
// Ambil data foto dengan kategori "Negara"
$query = "SELECT * FROM foto WHERE kategori='Negara' ORDER BY TanggalUnggah DESC";
...
<div class="container">
    ...
    <h2 class="text-center my-4">Album Negara</h2>
    <div class="row">
