...
// Ambil data foto dengan kategori "Barcelona"
$query = "SELECT * FROM foto WHERE kategori='Barcelona' ORDER BY TanggalUnggah DESC";
...
<div class="container">
    <h2 class="text-center my-4">Album Barcelona</h2>
