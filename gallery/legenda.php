...
// Ambil data foto dengan kategori "Legenda"
$query = "SELECT * FROM foto WHERE kategori='Legenda' ORDER BY TanggalUnggah DESC";
...
<div class="container">
    ...
    <h2 class="text-center my-4">Album Legenda</h2>
    <div class="row">
        ...
        <div class="col-lg-4 col-md-6 col-sm-12 gallery-item">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <!-- Tombol Download -->
                    <a href="img/<?php echo $row['LokasiFile']; ?>" download class="btn btn-primary">Download</a>
                </div>
            </div>
        </div>
        <?php endwhile; ?>
